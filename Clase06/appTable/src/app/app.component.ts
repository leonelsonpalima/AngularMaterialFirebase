...
import { MatPaginator, MatSort, MatDialog, MatDialogRef, MatSnackBar, MatSnackBarRef, SimpleSnackBar } from '@angular/material';
...
export class AppComponent {
  ...
  eliminar() {
    ...
    ref.componentInstance.mensaje = "¿Quieres eliminar?"
    ...
    ref.afterClosed()
      .subscribe(
        (result: any) => {
          ...
          const ref: MatSnackBarRef<SimpleSnackBar> = this.snackBar.open("Registro eliminado", "Cerrar", {
            duration: 3000,
            direction: "ltr",
